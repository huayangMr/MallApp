            ...
            <View style={{flex: 1, flexDirection: 'column', justifyContent: 'flex-start'}}>
                ...
                <View>
                    <ScrollView>
                        ...
                        >
                            <Image style={styles.banner_img}
                                   source={{uri: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1534849993575&di=e043de274022833c7cb1a127cf0f8077&imgtype=0&src=http%3A%2F%2Fattach.zhiyoo.com%2Fforum%2F201303%2F30%2F16392363kvt13er39xk1k3.jpg'}}/>
                            <Image style={styles.banner_img}
                                   source={{uri: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1534849993561&di=81d4263f021562ec51640e68cadf3962&imgtype=0&src=http%3A%2F%2Fp3.gexing.com%2FG1%2FM00%2FB9%2F56%2FrBACFFaM_VfRWJE0AAlNClgKv_o422.jpg'}}/>
                            <Image style={styles.banner_img}
                                   source={{uri: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1534849993573&di=3aae7f6e4f30f4f31eb1b614a82b93a4&imgtype=0&src=http%3A%2F%2Fpic.90sjimg.com%2Fback_pic%2Fqk%2Fback_origin_pic%2F00%2F03%2F88%2Fdc98489c7cd843578f414f0f470f9995.png'}}/>
                        </Swiper>
                        ...
                        <View style={styles.ads}>
                            <View style={styles.ads_child}>
                                <Image style={{resizeMode: 'contain', flex: 1}}
                                       source={{uri: 'http://imgsrc.baidu.com/image/c0%3Dpixel_huitu%2C0%2C0%2C294%2C40/sign=c0bb42321430e924dba9947125700b6a/4e4a20a4462309f757e1f228790e0cf3d7cad67a.jpg'}}/>
                            </View>
                            <View style={styles.ads_child}>
                                <Image style={{resizeMode: 'contain', flex: 1}}
                                       source={{uri: 'http://img.zyoulun.com/uploads/images/2014/06/10/9002d839a747f3869cd0ad74bee69a74.jpg'}}/>
                            </View>
                        </View>
                        <View style={styles.ads}>
                            <View style={styles.ads_child}>
                                <Image style={{resizeMode: 'contain', flex: 1}}
                                       source={{uri: 'http://www.haohead.com/z/uploads/attachment/9e/e9/a951be018db87156.jpg'}}/>
                            </View>
                            <View style={styles.ads_child}>
                                <Image style={{resizeMode: 'contain', flex: 1}}
                                       source={{uri: 'http://img.79.com/TJW/201705/1493973898_785542.jpg'}}/>
                            </View>
                        </View>
                    </ScrollView>
                </View>
                <ActionButton position='right' verticalOrientation='up' buttonColor="rgba(231,76,60,1)">
                    ...
                    <ActionButton.Item size={66} buttonColor='#1abc9c' title="二维码"
                                       onPress={() => this.props.navigation.navigate('adCode')}>
